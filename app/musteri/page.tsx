...
export default function CustomerPage() {
  ...
  const submit = async () => {
    const cleanSignupPhone = normalizeLocalPhone(form.phone);
    const missingSignup = mode === "signup" && (!form.username.trim() || !form.fullName.trim() || !form.email.trim() || !form.password || !/^0\d{10}$/.test(cleanSignupPhone));
